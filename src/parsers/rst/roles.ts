...
function setClasses(options: any): void {
    if ('class' in options) {
...
class GenericRole {
    ...
    public constructor(roleName: string, nodeClass: any) {
        this.name = roleName;
 ...
 */
function registerLocalRole(name: string, roleFn: any): void {
 ...
 */
function roleInterface(roleName: string, languageModule: any, lineno: number, reporter: ReporterInterface): any[] {
 ...
 *   - `roleFn`: The role function.  See the module docstring.
 */
function registerCanonicalRole(name: string, roleFn: any): void {
    setImplicitOptions(roleFn);
    roleRegistry[name] = roleFn;
}

/** For roles which simply wrap a given `node_class` around the text. */
function registerGenericRole(canonicalName: string, nodeClass: any): void {
