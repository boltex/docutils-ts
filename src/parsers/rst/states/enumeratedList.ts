...
import { RegexpResult, ContextArray, StateType, StateInterface, ParseMethodReturnType } from '../../../types.js';
...
*/
    ...
    private is_enumerated_list_item(ordinal: number | undefined, sequence: string, format: string): boolean {
        ...
        if (result) {
            ...
            if (nextLine!.startsWith(nextEnumerator) || nextLine!.startsWith(autoEnumerator)) {
                return true;
            }
            return false;
        }
